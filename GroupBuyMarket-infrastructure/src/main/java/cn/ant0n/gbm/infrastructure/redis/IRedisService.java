...
public interface IRedisService {
    ...
    <T> void setValue(String key, T value, int expired);
     ...
     * @return 返回结果
     */
    boolean setNx(String cacheKey);


    /**
     * 如果不存在则设置
     *
     * @param lockKey 分布式锁名 expireMillis 过期时间 timeUnit 时间单位
     * @return 返回结果
     */
     ...
     * @return 位图
     */
    RBitSet getBitSet(String cacheKey);

    void setBitSet(String cacheKey, int index);

    void setBitSetEx(String cacheKey, int time);
