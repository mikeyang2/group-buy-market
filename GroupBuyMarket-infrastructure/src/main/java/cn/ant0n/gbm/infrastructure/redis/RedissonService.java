package cn.ant0n.gbm.infrastructure.redis;
...
public class RedissonService implements IRedisService {
    ...
    @Override
    public <T> void setValue(String key, T value, int expired) {
        RBucket<T> bucket = redissonClient.getBucket(key);
    ...
    @Override
    public boolean setNx(String cacheKey) {
        return redissonClient.getBucket(cacheKey).trySet("lock");
    }
    ...
    @Override
    public RBitSet getBitSet(String cacheKey) {
        return redissonClient.getBitSet(cacheKey);
    }

    @Override
    public void setBitSet(String cacheKey, int index) {
        RBitSet bitSet = redissonClient.getBitSet(cacheKey);
        bitSet.set(index);
    }

    @Override
    public void setBitSetEx(String cacheKey, int time) {
        redissonClient.getBitSet(cacheKey).expire(time, TimeUnit.HOURS);
    }
